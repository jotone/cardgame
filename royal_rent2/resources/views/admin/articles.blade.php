						...
						<tr>
							...
							<th>Название
								<div class="direction" id="title">
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=title&dir=asc') }}" class=asc>&#9650;</a>
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=title&dir=desc') }}" class=desc>&#9660;</a>
								</div>
							</th>
							<th>Ссылка
								<div class="direction" id="slug">
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=slug&dir=asc') }}" class=asc>&#9650;</a>
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=slug&dir=desc') }}" class=desc>&#9660;</a>
								</div>
							</th>
							<th>Превью</th>
							<th>Автор
								<div class="direction" id="author">
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=author&dir=asc') }}" class=asc>&#9650;</a>
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=author&dir=desc') }}" class=desc>&#9660;</a>
								</div>
							</th>
							<th>Просмотров
								<div class="direction" id="views">
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=views&dir=asc') }}" class=asc>&#9650;</a>
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=views&dir=desc') }}" class=desc>&#9660;</a>
								</div>
							</th>
							<th>Опубликован
								<div class="direction" id="published">
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=published&dir=asc') }}" class=asc>&#9650;</a>
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=published&dir=desc') }}" class=desc>&#9660;</a>
								</div>
							</th>
							<th>Создан
								<div class="direction" id="created">
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=created&dir=asc') }}" class=asc>&#9650;</a>
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=created&dir=desc') }}" class=desc>&#9660;</a>
								</div>
							</th>
							<th>Изменен
								<div class="direction" id="updated">
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=updated&dir=asc') }}" class=asc>&#9650;</a>
									<a href="{{ URL::asset('/admin/'.$global_slug.'/?page='.$pagination['current_page'].'&sort_by=updated&dir=desc') }}" class=desc>&#9660;</a>
								</div>
							</th>
						</tr>
					</thead>
